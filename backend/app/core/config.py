...
class Settings:
    ...
    NGROK_BASE_URL: str = os.getenv("NGROK_BASE_URL", "https://4893b8fa01e6.ngrok-free.app")
    ...
    # Facebook OAuth - Use BASE_URL if set, otherwise use appropriate URL based on environment
    BASE_URL: str = os.getenv("BASE_URL", "")
    FB_REDIRECT_URI: str = (
        f"{BASE_URL}/api/v1/facebook/callback" if BASE_URL 
        else f"{NGROK_BASE_URL}/api/v1/facebook/callback" if USE_NGROK 
        else f"http://localhost:8000/api/v1/facebook/callback"
    )
