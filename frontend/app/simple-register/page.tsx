...
/**
 * Simple Registration Page - Bypasses Complex Hydration Issues
 * ===========================================================
 * 
 * This is a minimal registration form that works directly with our backend API
        ...
        <div className="glass-card p-6 sm:p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white/20">
          <div className="text-center">
            ...
            <p className="mt-3 sm:mt-2 text-sm text-gray-600 leading-relaxed">
              ...
              <a href="/simple-login" className="font-medium text-indigo-600 hover:text-indigo-500">
                Sign in
              </a>
            </p>
          </div>
          ...
          <form 
            ...
            action="/api/auth/simple-register" 
            method="POST"
          >
            <div className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="appearance-none relative block w-full px-3 py-3 sm:py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base sm:text-sm"
