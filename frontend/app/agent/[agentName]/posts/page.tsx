        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-2xl mx-auto py-6 px-4">
                <div className="mb-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Property Marketing</h2>
                    <p className="text-gray-600 mb-4">Property-focused marketing updates and market insights from {agent?.agent_name || 'our agent'}.</p>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <p className="text-blue-800 text-sm mb-3">
                            💡 <strong>Looking for properties?</strong> All our featured properties with detailed marketing information are now showcased on the main page.
                        </p>
                        <Link
